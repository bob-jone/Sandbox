...
public class BasicCube : BasicCubeBehavior
{
    ...
    // From this documentation: https://github.com/BeardedManStudios/ForgeNetworkingRemastered/wiki/basic-moving-cube-example
    ...
    void Update()
    {
        ...
        // on the network is **very** rare, but better to be safe 100%
